...
class ModelFit(BasicShellApplication):
    ...
    def run(self, args):
        ...
        mdt.fit_model(args.model, os.path.realpath(args.dwi), os.path.realpath(args.protocol),
                      os.path.realpath(args.mask), output_folder, recalculate=args.recalculate,
