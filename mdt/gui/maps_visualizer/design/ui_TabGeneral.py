...
class Ui_TabGeneral(object):
    def setupUi(self, TabGeneral):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.general_show_axis)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.general_colorbar_nmr_ticks)
