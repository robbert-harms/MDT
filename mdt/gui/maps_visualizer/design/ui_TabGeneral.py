...
class Ui_TabGeneral(object):
    def setupUi(self, TabGeneral):
        ...
        TabGeneral.setTabOrder(self.general_rotate, self.general_font_size)
        TabGeneral.setTabOrder(self.general_font_size, self.general_show_axis)
    ...
    def retranslateUi(self, TabGeneral):
        ...
        self.label_3.setText(_translate("TabGeneral", "Font size:"))
