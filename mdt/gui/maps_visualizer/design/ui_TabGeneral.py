...
class Ui_TabGeneral(object):
    def setupUi(self, TabGeneral):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 946, 1151))
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.general_flipud)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.general_interpolation)
        ...
        self.general_info_directory.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByMouse)
    ...
    def retranslateUi(self, TabGeneral):
        ...
        self.label_7.setText(_translate("TabGeneral", "Number of maps:"))
