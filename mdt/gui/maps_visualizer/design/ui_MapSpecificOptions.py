...
class Ui_MapSpecificOptions(object):
    def setupUi(self, MapSpecificOptions):
        ...
        self.data_scale_max = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.data_scale_max.setMinimum(-999999.99)
        self.data_scale_max.setMaximum(999999.99)
        self.data_scale_max.setObjectName("data_scale_max")
        self.verticalLayout.addWidget(self.data_scale_max)
        self.data_scale_min = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.data_scale_min.setSpecialValueText("")
        self.data_scale_min.setMinimum(-999999.99)
        self.data_scale_min.setMaximum(999999.99)
        ...
        self.data_clipping_max = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.data_clipping_max.setMinimum(-999999.99)
        self.data_clipping_max.setMaximum(999999.99)
        self.data_clipping_max.setObjectName("data_clipping_max")
        self.verticalLayout_2.addWidget(self.data_clipping_max)
        self.data_clipping_min = QtWidgets.QDoubleSpinBox(self.frame_4)
        self.data_clipping_min.setMinimum(-999999.99)
        self.data_clipping_min.setMaximum(999999.99)
