...
class Ui_MapSpecificOptions(object):
    def setupUi(self, MapSpecificOptions):
        ...
        self.data_scale_min = QDoubleSpinBoxDotSeperator(self.frame_6)
        ...
        self.data_scale_max = QDoubleSpinBoxDotSeperator(self.frame_6)
        ...
        self.data_clipping_min = QDoubleSpinBoxDotSeperator(self.frame_8)
        ...
        self.data_clipping_max = QDoubleSpinBoxDotSeperator(self.frame_8)
...
from ..widgets import CollapsablePanel, CollapsablePanelContent, CollapsablePanelHeader, QDoubleSpinBoxDotSeperator
