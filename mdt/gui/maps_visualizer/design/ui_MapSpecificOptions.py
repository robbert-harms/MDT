...
class Ui_MapSpecificOptions(object):
    def setupUi(self, MapSpecificOptions):
        ...
        self.gridLayout_3.addWidget(self.colormap, 4, 1, 1, 1)
        ...
        self.gridLayout_5.setContentsMargins(-1, -1, -1, 4)
        ...
        self.gridLayout_5.addWidget(self.data_clipping_max, 0, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.data_clipping_min, 1, 0, 1, 1)
        self.use_data_clipping_max = QtWidgets.QCheckBox(self.frame_4)
        self.use_data_clipping_max.setText("")
        self.use_data_clipping_max.setObjectName("use_data_clipping_max")
        self.gridLayout_5.addWidget(self.use_data_clipping_max, 0, 1, 1, 1)
        self.use_data_clipping_min = QtWidgets.QCheckBox(self.frame_4)
        self.use_data_clipping_min.setText("")
        self.use_data_clipping_min.setObjectName("use_data_clipping_min")
        self.gridLayout_5.addWidget(self.use_data_clipping_min, 1, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.data_set_use_clipping, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.data_scale_min, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.data_scale_max, 0, 0, 1, 1)
        self.use_data_scale_max = QtWidgets.QCheckBox(self.frame_4)
        self.use_data_scale_max.setText("")
        self.use_data_scale_max.setObjectName("use_data_scale_max")
        self.gridLayout_2.addWidget(self.use_data_scale_max, 0, 1, 1, 1)
        self.use_data_scale_min = QtWidgets.QCheckBox(self.frame_4)
        self.use_data_scale_min.setText("")
        self.use_data_scale_min.setObjectName("use_data_scale_min")
        self.gridLayout_2.addWidget(self.use_data_scale_min, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.data_set_use_scale, 2, 1, 1, 1)
        ...
        MapSpecificOptions.setTabOrder(self.data_colorbar_label, self.data_scale_max)
        MapSpecificOptions.setTabOrder(self.data_scale_max, self.use_data_scale_max)
        MapSpecificOptions.setTabOrder(self.use_data_scale_max, self.data_scale_min)
        MapSpecificOptions.setTabOrder(self.data_scale_min, self.use_data_scale_min)
        ...
        MapSpecificOptions.setTabOrder(self.data_clipping_max, self.use_data_clipping_max)
        MapSpecificOptions.setTabOrder(self.use_data_clipping_max, self.data_clipping_min)
        MapSpecificOptions.setTabOrder(self.data_clipping_min, self.use_data_clipping_min)
    ...
    def retranslateUi(self, MapSpecificOptions):
        ...
        self.label_2.setText(_translate("MapSpecificOptions", "Use clipping:"))
        self.label_10.setText(_translate("MapSpecificOptions", "Scale:"))
        self.label.setText(_translate("MapSpecificOptions", "Use scaling:"))
