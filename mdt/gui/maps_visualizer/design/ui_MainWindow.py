...
class Ui_MapsVisualizer(object):
    def setupUi(self, MapsVisualizer):
        ...
        self.general_font_size = QtWidgets.QSpinBox(self.frame_10)
        self.general_font_size.setObjectName("general_font_size")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.general_font_size)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.general_show_axis)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.general_colorbar_nmr_ticks)
        ...
        MapsVisualizer.setTabOrder(self.general_volume_index, self.general_zoom_x_0)
        MapsVisualizer.setTabOrder(self.general_zoom_x_0, self.general_zoom_y_0)
        MapsVisualizer.setTabOrder(self.general_zoom_y_0, self.general_zoom_x_1)
        MapsVisualizer.setTabOrder(self.general_zoom_x_1, self.general_zoom_y_1)
        MapsVisualizer.setTabOrder(self.general_zoom_y_1, self.general_map_selection)
        MapsVisualizer.setTabOrder(self.general_map_selection, self.general_display_order)
        MapsVisualizer.setTabOrder(self.general_display_order, self.general_colormap)
        MapsVisualizer.setTabOrder(self.general_colormap, self.general_rotate)
        MapsVisualizer.setTabOrder(self.general_rotate, self.lineEdit)
    ...
    def retranslateUi(self, MapsVisualizer):
        ...
        self.label_3.setText(_translate("MapsVisualizer", "Font size:"))
        self.label_4.setText(_translate("MapsVisualizer", "Show axis:"))
        self.label_5.setText(_translate("MapsVisualizer", "Colorbar nmr ticks:"))
...
from ..widgets import CollapsablePanel, CollapsablePanelContent, CollapsablePanelHeader, MapsReorderer, TextConfigEditor
from . import main_rc
