...
class Ui_MapsVisualizer(object):
    def setupUi(self, MapsVisualizer):
        ...
        MapsVisualizer.setTabOrder(self.commandTabs, self.scrollArea)
        MapsVisualizer.setTabOrder(self.scrollArea, self.general_dimension)
        MapsVisualizer.setTabOrder(self.general_dimension, self.general_slice_index)
        MapsVisualizer.setTabOrder(self.general_slice_index, self.general_volume_index)
        MapsVisualizer.setTabOrder(self.general_volume_index, self.spinBox_14)
        MapsVisualizer.setTabOrder(self.spinBox_14, self.spinBox_12)
        MapsVisualizer.setTabOrder(self.spinBox_12, self.spinBox_11)
        MapsVisualizer.setTabOrder(self.spinBox_11, self.spinBox_13)
        MapsVisualizer.setTabOrder(self.spinBox_13, self.general_map_selection)
        MapsVisualizer.setTabOrder(self.general_map_selection, self.selectMaps_3)
        MapsVisualizer.setTabOrder(self.selectMaps_3, self.general_colormap)
        MapsVisualizer.setTabOrder(self.general_colormap, self.general_rotate)
        MapsVisualizer.setTabOrder(self.general_rotate, self.scrollArea_2)
        MapsVisualizer.setTabOrder(self.scrollArea_2, self.comboBox)
        MapsVisualizer.setTabOrder(self.comboBox, self.lineEdit)
    ...
    def retranslateUi(self, MapsVisualizer):
        ...
        self.label_20.setText(_translate("MapsVisualizer", "<html><head/><body><p>x<span style=\" vertical-align:sub;\">0</span>:</p></body></html>"))
        self.label_19.setText(_translate("MapsVisualizer", "y<sub>0</sub>:"))
        self.label_18.setText(_translate("MapsVisualizer", "y<sub>1</sub>:"))
        self.label_12.setText(_translate("MapsVisualizer", "x<sub>1</sub>:"))
