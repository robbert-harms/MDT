...
class Ui_FitModelTabContent:
    def setupUi(self, FitModelTabContent):
        ...
        self.label_16 = QtWidgets.QLabel(FitModelTabContent)
        self.label_16.setMinimumSize(QtCore.QSize(0, 0))
        self.label_16.setObjectName("label_16")
        self.gridLayout.addWidget(self.label_16, 8, 0, 1, 1)
        self.label_19 = QtWidgets.QLabel(FitModelTabContent)
        self.label_19.setMinimumSize(QtCore.QSize(0, 0))
        self.label_19.setObjectName("label_19")
        self.gridLayout.addWidget(self.label_19, 7, 0, 1, 1)
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.useCascades = QtWidgets.QRadioButton(FitModelTabContent)
        self.useCascades.setChecked(True)
        self.useCascades.setObjectName("useCascades")
        self.cascadedFitButtonGroup = QtWidgets.QButtonGroup(FitModelTabContent)
        self.cascadedFitButtonGroup.setObjectName("cascadedFitButtonGroup")
        self.cascadedFitButtonGroup.addButton(self.useCascades)
        self.horizontalLayout_8.addWidget(self.useCascades)
        self.noCascades = QtWidgets.QRadioButton(FitModelTabContent)
        self.noCascades.setObjectName("noCascades")
        self.cascadedFitButtonGroup.addButton(self.noCascades)
        self.horizontalLayout_8.addWidget(self.noCascades)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_8.addItem(spacerItem1)
        self.gridLayout.addLayout(self.horizontalLayout_8, 7, 1, 1, 1)
        self.cascadeSelection = QtWidgets.QComboBox(FitModelTabContent)
        self.cascadeSelection.setObjectName("cascadeSelection")
        self.gridLayout.addWidget(self.cascadeSelection, 8, 1, 1, 1)
        self.line_5 = QtWidgets.QFrame(FitModelTabContent)
        self.line_5.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
        self.gridLayout.addWidget(self.line_5, 6, 0, 1, 3)
        self.label_18 = QtWidgets.QLabel(FitModelTabContent)
        font = QtGui.QFont()
        font.setItalic(True)
        self.label_18.setFont(font)
        self.label_18.setObjectName("label_18")
        self.gridLayout.addWidget(self.label_18, 7, 2, 2, 1)
    ...
    def retranslateUi(self, FitModelTabContent):
        ...
        self.label_16.setText(_translate("FitModelTabContent", "Select cascade:"))
        self.label_19.setText(_translate("FitModelTabContent", "Use cascaded fit:"))
        self.useCascades.setText(_translate("FitModelTabContent", "Yes"))
        self.noCascades.setText(_translate("FitModelTabContent", "No"))
        self.label_18.setText(_translate("FitModelTabContent", "(Initializes your chosen model using parameter estimates\n"
"of simpler model estimates)"))
