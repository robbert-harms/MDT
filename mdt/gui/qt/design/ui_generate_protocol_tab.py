...
class Ui_ViewResultsTabContent(object):
    def setupUi(self, ViewResultsTabContent):
        ...
        ViewResultsTabContent.resize(827, 427)
    ...
    def retranslateUi(self, ViewResultsTabContent):
        ...
        self.label.setText(_translate("ViewResultsTabContent", "Generate protocol file"))
        self.label_2.setText(_translate("ViewResultsTabContent", "Create a protocol file containing all your sequence information."))
