...
class FitStrategies(ComponentsLoader):

    def __init__(self):
        super(FitStrategies, self).__init__([UserComponentsSourceSingle('user', 'fit_strategies'),
                                             UserComponentsSourceSingle('standard', 'fit_strategies')])
