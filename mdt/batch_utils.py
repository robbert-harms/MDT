...
class SubjectInfo(object):
    ...
    def get_mask_info(self):
        ...
        Returns:
            ndarray, str or None: either a string with the mask to use or a string with the filename of the mask
                This can also return None, which means no mask can be found and a mask should be generated by the
                batch fitting routine.
        """
        return None
...
class SimpleProtocolLoader(ProtocolLoader):
    ...
    def __init__(self, prtcl_fname=None, bvec_fname=None, bval_fname=None,
        ...
        """A simple protocol loader for loading from a protocol file or bvec/bval files.
